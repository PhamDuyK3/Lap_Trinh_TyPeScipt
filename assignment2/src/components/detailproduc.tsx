...
<section className="text-gray-700 body-font overflow-hidden bg-white">
  <div className="container px-5 py-10 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <img src="/detail.png" alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <div className="pb-2">
        <span className="title-font font-medium text-[25px] pr-4 text-[#D70018]">11.690.000 ₫</span>
        <span className="title-font font-medium text-[14px] text-[#707070]">11.690.000 ₫</span>
        </div>
        <h2 className="text-sm title-font text-gray-500 tracking-widest">SAMSUNG</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Samsung Galaxy A73 (5G) 256GB</h1>
