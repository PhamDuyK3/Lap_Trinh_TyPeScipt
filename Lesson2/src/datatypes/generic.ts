...
const strArr=["Hòa","Duy","Vũ Anh"]
// const result=numArr.map(item=>{
//     return item * item
// })
// console.log(result);
// function we17305_map2<T>(arr:T[],callback:(item:T,index:number)=>T):T[]{
//     let temp=[]
...
//     return temp
// }
// const result= we17305_map2(strArr,(item,index)=>{
//     return item+ "-WEB17305"
// })
// console.log(result,"WEB17305_map");
